...
(function() {
  var ARGC, ARGV, CONF, CONF_FILE, HOME, LOG_FILE, MAN_PAGE, MSG_STATUS, PAGER, PROG, QUERY, VERSION, fs, http, http_cmd, name, number, path, print_account_balance, print_message_status, querystring, sanitize_phone_number, send_message, shell, spawn, _ref, _ref1, _ref2;
  ...
  PAGER = (_ref1 = process.env.PAGER) != null ? _ref1 : 'less';
  ...
  print_message_status = function(msgid) {
    ...
    return http_cmd('getmsgcharge', function(result) {
      var _ref2;
      return console.info(result + ' (' + ((_ref2 = MSG_STATUS[result.slice(-3)]) != null ? _ref2 : '') + ')');
    });
  };
